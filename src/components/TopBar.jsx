...
import { BG, CYAN, TOP_BAR_H } from '../constants/index.js';

export function TopBar({ query, onNewQuery }) {
  return (
    <div style={{
      ...
      <button
        ...
        onMouseEnter={e => { e.target.style.borderColor = CYAN; e.target.style.color = CYAN; e.target.style.boxShadow = `0 0 8px ${CYAN}33`; }}
        onMouseLeave={e => { e.target.style.borderColor = `${CYAN}33`; e.target.style.color = `${CYAN}77`; e.target.style.boxShadow = 'none'; }}
      >
        NEW QUERY
      </button>
    </div>
